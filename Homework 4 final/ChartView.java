   ...
   */
     private void drawQtrEarnings(Graphics g) {
      ...
      for( QuarterlyStockEarnings q : qse) {
          ...
          if (q.getTrend().equals("up")) {
              drawTriangle( g,(int)(x0), (int)(y0 - 6), (int)(x0 - 6), (int)(y0 + 6), (int)(x0 + 6), (int)(y0 + 6),Color.green);
            }
            // Negative Earnings
          else if (q.getTrend().equals("down")) {
              drawTriangle( g,(int)(x0), (int)(y0 + 6), (int)(x0 + 6), (int)(y0 - 6), (int)(x0 - 6), (int)(y0 - 6),Color.red);
            }
            // Zero Earnings
            else{
                drawTriangle( g,(int)(x0), (int)(y0 - 6), (int)(x0), (int)(y0 + 6), (int)(x0 + 6), (int)(y0),Color.blue);
            }
     ...
     */     
     ...
     private void drawHighLight(Graphics g) {
         ...
         g.fillRect(this.start,(int)(this.height*0.1),  this.stop - this.start,gHeight);
        }
        else if ( this.stop < this.start) {
         g.fillRect(this.stop,(int)(this.height*0.1),  this.start - this.stop,gHeight);
    }
                }   
